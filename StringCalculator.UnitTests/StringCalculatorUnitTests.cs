...
namespace StringCalculator.UnitTests
{
    public class StringCalculatorUnitTests
    {
        ...
        [Fact]
        public void Add_WhenMoreNumbersThenTwoNumbers_ShouldThrowException()
        {
            var sut = new Domain.StringCalculator();
        ...
        [Fact]
        public void Add_WhenContainsNonNumbers_ShouldThrowArgumentExpetion()
        {
            var sut = new Domain.StringCalculator();
        ...
        [Fact]
        public void Add_WhenValidInput_RetunsSum()
        {
            var sut = new Domain.StringCalculator();
